<x-web-layout>
    ...
    <section class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Creativity Assessment (Brahmacharya)</h1>
                    <ul class="breadcrumb breadcrumb--classic">
                        <li><a href="/"><i class="fa fa-home"></i></a></li>
                        <li class="active"><a>Creativity Assessment (Brahmacharya)</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="details">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>Creativity is generally defined as the ability to produce work that is novel and appropriate. Go through the creativity assessment to figure out how creative you are.</p>
                    <p>Download the below document for creativity assessment.</p>
                    <p><a href="{{ asset('pdfs/creativity-brahmacharya-assessment.pdf') }}" class="btn btn-register"> Download Assessment Document </a></p>               
                </div>
            </div>
        </div>
    </section>
