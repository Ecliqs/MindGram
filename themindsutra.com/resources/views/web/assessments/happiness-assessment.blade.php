<x-web-layout>
    ...
    <section class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Happiness Assessment (Santosh)</h1>
                    <ul class="breadcrumb breadcrumb--classic">
                        <li><a href="/"><i class="fa fa-home"></i></a></li>
                        <li class="active"><a>Happiness Assessment (Santosh)</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="details">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>Mindfulness is the ability to stay focused, while being aware of your thoughts and surroundings and being able to recognize and move past distractions as they arise. GO through this mindfulness assessment to know how mindful you are.</p>
