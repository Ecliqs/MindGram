                        ...
                        <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                            ...
                            <tr>
                                <td style="padding:30px;background-color:#ffffff;">
                                    <h1 style="margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">New Registration for Event</h1>
                                    <p style="margin:0;"></p>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:35px 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                                    ...
                                    <div class="col-lge" style="display:inline-block;width:100%;max-width:395px;vertical-align:top;padding-bottom:20px;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                                        <h3>{{ $mailData['name'] }}</h3>
                                        <p style="margin-top:0;margin-bottom:12px;">Event: <a href="mailto:'.$_POST['email'].'">{{ $mailData['event'] }}.'</a></p>
                                        <p style="margin-top:0;margin-bottom:12px;">Email: <a href="mailto:'.$_POST['email'].'">{{ $mailData['email'] }}.'</a></p>
                                        <p style="margin-top:0;margin-bottom:12px;">Mobile: <a href="tel:'.$_POST['mobile'].'">{{ $mailData['mobile'] }}.'</a></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
