<x-web-layout>
    ...
    <section class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Mindsutra Arts</h1>
                    <ul class="breadcrumb breadcrumb--classic">
                        <li><a href="/"><i class="fa fa-home"></i></a></li>
                        <li class="active"><a>Mindsutra Arts</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    <div class="magnific-img">
                        <a class="image-popup-vertical-fit" href="{{ asset('images/web/arts/art2.jpg') }}" title="Clarity with Satya">
                            <img src="{{ asset('images/web/arts/art2.jpg') }}" alt="" width="100%"/>
                        </a>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="row">
                        <div class="magnific-img mb-4">
                            <a class="image-popup-vertical-fit" href="{{ asset('images/web/arts/art1.jpg') }}" title="Freedom with Aparigraha">
                                <img src="{{ asset('images/web/arts/art1.jpg') }}" alt="" width="100%"/>
                            </a>
                        </div>
                        <div class="magnific-img mb-4">
                            <a class="image-popup-vertical-fit" href="{{ asset('images/web/arts/art3.jpg') }}" title="">
                                <img src="{{ asset('images/web/arts/art3.jpg') }}" alt="" width="100%"/>
                            </a>
                        </div>
                        <div class="magnific-img mb-4">
                            <a class="image-popup-vertical-fit" href="{{ asset('images/web/arts/art4.jpg') }}" title="Flow with Brahmachacharya">
                                <img src="{{ asset('images/web/arts/art4.jpg') }}" alt="" width="100%"/>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="row">
                        <div class="magnific-img">
                            <a class="image-popup-vertical-fit" href="{{ asset('images/web/arts/art5.jpg') }}" title="One with Ahimsa">
                                <img src="{{ asset('images/web/arts/art5.jpg') }}" alt="" width="100%"/>
                            </a>
                        </div>
                    </div>
                </div>
